...
public class MorningGlory extends FlowerCard
{
    public static final String ID = Agrypnos.createID("MorningGlory");
    ...
    private static final int LOSS = 4;
    ...
    public MorningGlory() {
        ...
        this.magicNumber = this.baseMagicNumber = LOSS;
    }
