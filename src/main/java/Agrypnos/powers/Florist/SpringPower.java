...
public class SpringPower extends AbstractPower {
    public static final String POWER_ID = Agrypnos.createID("SpringPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final String IMG = Agrypnos.makePath(PowerImages.SPRING);

    private AbstractCard seedCard;

    //make separate spring power for upgraded seeds

    public SpringPower(final AbstractCreature owner, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
